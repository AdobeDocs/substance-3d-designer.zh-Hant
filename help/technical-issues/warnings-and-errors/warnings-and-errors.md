...
對於檔案總管](../../interface/the-explorer-window/the-explorer-window.md)面板中[任何有警告的項目，該警告會在列表中該項目條目最右側邊緣顯示![](../../assets/warning-icon.png)。將游標停留在該圖示上幾秒鐘，會顯示 *一個詳細列出所有警告的工具提示* 。
