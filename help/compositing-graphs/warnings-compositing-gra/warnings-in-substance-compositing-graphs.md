...
### ![（錯誤）](../../assets/error.svg)*[x]* 參數的函式有一些警告
...
在圖譜檢視](../../interface/the-graph-view/the-graph-view.md)中，透過標籤和警告徽[章找到發出警告的節點，然後選擇它在屬性](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/parameters-ui-129368153.html)面板中[顯示其屬性。找到發出警告的參數，點擊「編輯功能&#x200B;**」按鈕開啟其函式**。
...
![修正「參數函數有某些警告」警告](../../assets/warnings-comp-param-function.gif "修正「參數函數有某些警告」警告")
...
![修正「參考資料有警告」](../../assets/warnings-comp-referenced-data.gif "警告 修正「參考資料有警告」警告")
...
### ![（錯誤）](../../assets/error.svg) 文字節點使用無效字型
