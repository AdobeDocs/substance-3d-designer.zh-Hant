...
![修正「未定義輸出節點」警告](warnings-in-substance-compositing-graphs.resources/warnings-in-substance-compositing-graphs-01.gif "修正「未定義輸出節點」警告"){width="512px"}
...
![修正「參數函數有某些警告」警告](warnings-in-substance-compositing-graphs.resources/warnings-in-substance-compositing-graphs-02.gif "修正「參數函數有某些警告」警告")
...
![修正「參考資料有警告」](warnings-in-substance-compositing-graphs.resources/warnings-in-substance-compositing-graphs-03.gif "警告 修正「參考資料有警告」警告")
...
![修正「找不到參考資源」警告](warnings-in-substance-compositing-graphs.resources/warnings-in-substance-compositing-graphs-04.gif "修正「找不到參考資源」警告")
...
<b>![（勾選）（警告-in-substance-compositing-graphs.resources/check.svg）解決方案</b>
