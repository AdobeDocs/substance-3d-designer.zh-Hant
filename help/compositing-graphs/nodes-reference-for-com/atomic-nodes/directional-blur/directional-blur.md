...
![原子節點：方向模糊](directional-blur.resources/comp_dirmotionblur_1.png "原子節點：方向模糊"){width="200px"}
...
![各向異性模糊比較](directional-blur.resources/aniso-01.png "各向異性模糊比較"){zoomable="yes"}
