...
![原子節點：輸入值](input-value.resources/comp_inputnumeric_1.png "原子節點：輸入值"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-value.resources/input-value-tooltip.gif" alt="輸入值工具提示" /></div>
...
![Substance 圖中的主要輸入](input-value.resources/node-primary-input.png){width="20%"}
