...
![原子節點：SVG](svg.resources/comp_svg_1.png "原子節點：SVG"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="svg.resources/svg-tooltip.gif" alt="SVG 工具提示" /></div>
