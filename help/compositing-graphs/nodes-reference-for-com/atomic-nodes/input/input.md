...
![原子節點：輸入顏色](input.resources/comp_inputcolor_1.png "原子節點：輸入顏色"){width="20%"}

</td>
<td style="border: 0;" valign="top">

![原子節點：輸入灰階](input.resources/comp_inputgrayscale_1.png "原子節點：輸入灰階"){width="20%"}

</td>
<td style="border: 0;" valign="top">

![原子節點：輸入值](input.resources/comp_inputnumeric_1.png "原子節點：輸入值"){width="20%"}

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input.resources/input-color-tooltip.gif" alt="輸入色彩工具提示" /></div>
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input.resources/input-grayscale-tooltip.gif" alt="輸入灰階工具提示" /></div>
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input.resources/input-value-tooltip.gif" alt="輸入值工具提示" /></div>
...
![Substance 圖中的主要輸入](input.resources/node-primary-input.png){width="20%"}
