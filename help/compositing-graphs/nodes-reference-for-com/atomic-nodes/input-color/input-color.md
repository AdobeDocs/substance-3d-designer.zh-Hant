...
![原子節點：輸入顏色](input-color.resources/comp_inputcolor_1.png "原子節點：輸入顏色"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-color.resources/input-color-tooltip.gif" alt="輸入色彩工具提示" /></div>
...
![Substance 圖中的主要輸入](input-color.resources/node-primary-input.png){width="20%"}
