...
![混合模式：複製](blending-modes-description.resources/image2015-8-20-9-38-0.png "混合模式：複製"){zoomable="yes"}

對於彩色影像，透明度預設會考慮 alpha 通道。

這可以透過使用「Alpha blending」參數來改變。

![混合模式：複製（2）](blending-modes-description.resources/image2015-8-20-14-15-29.png "混合模式：複製（2）"){zoomable="yes"}

## 加法（線性閃避）

*新增*&#x200B;混合模式會將前景輸入值加入背景中對應的每個像素。

![混合模式：加（線性閃避）](blending-modes-description.resources/image2015-8-20-9-38-19.png "混合模式：加（線性閃避）"){zoomable="yes"}
...
![混合模式：減法](blending-modes-description.resources/image2015-8-20-9-38-35.png "混合模式：減法"){zoomable="yes"}
...
![混合模式：乘法](blending-modes-description.resources/image2015-8-20-9-38-53.png "混合模式：乘法"){zoomable="yes"}
...
![混合模式：新增字幕](blending-modes-description.resources/image2015-8-20-9-39-11.png "混合模式：新增字幕"){zoomable="yes"}

## 麥克斯（Lighten）

*最大*&#x200B;混合模式會選擇背景與前景之間的較高值。

![混合模式：最大（變亮）](blending-modes-description.resources/image2015-8-20-9-40-12.png "混合模式：最大（變淺）"){zoomable="yes"}

## 敏（暗黑）

*最小*&#x200B;混合模式會選擇背景與前景之間的較低值。

![混合模式：最小（加深）](blending-modes-description.resources/image2015-8-20-9-40-31.png "混合模式：最小化（加深）"){zoomable="yes"}
...
![混合模式：切換](blending-modes-description.resources/image2015-8-20-9-38-0.png "混合模式：切換"){zoomable="yes"}

## 分界

*除法*&#x200B;混合模式會將背景輸入像素的值除以前景中對應的每個像素。

![混合模式：除](blending-modes-description.resources/image2015-8-20-9-41-32.png "法 混合模式：分割"){zoomable="yes"}
...
![混合模式：疊加](blending-modes-description.resources/image2015-8-20-9-41-50.png "混合模式：疊加"){zoomable="yes"}
...
![混合模式：螢幕](blending-modes-description.resources/image2015-8-20-9-42-11.png "混合模式：螢幕"){zoomable="yes"}
...
![混合模式：柔光](blending-modes-description.resources/image2015-8-20-9-42-32.png "混合模式：柔光"){zoomable="yes"}
