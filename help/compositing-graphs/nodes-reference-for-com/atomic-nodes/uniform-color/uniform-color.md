---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/atomic-nodes/uniform-color.html"
breadcrumb-title: ""
...
![原子節點：均勻顏色](uniform-color.resources/comp_uniform_1.png "原子節點：均勻顏色"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="uniform-color.resources/uniform-color-tooltip.gif" alt="統一色彩工具提示" /></div>
...
> 
> * 如果需要灰階值，請確保節點的色彩模式[&#128279;](#parameters)切換為「灰階」。
