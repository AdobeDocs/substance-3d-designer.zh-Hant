...
![原子節點：輸出](output.resources/comp_output_1.png "原子節點：輸出")
...
<div data-preserve-html="true" style="text-align: center;"><img src="output.resources/output-tooltip.gif" alt="輸出工具提示" /></div>
