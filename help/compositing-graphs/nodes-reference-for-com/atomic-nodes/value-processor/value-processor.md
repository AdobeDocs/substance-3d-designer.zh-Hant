...
![原子節點：價值處理器](value-processor.resources/comp_valueprocessor_1.png "原子節點：價值處理器"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="value-processor.resources/value-processor-tooltip.gif" alt="價值處理工具提示" /></div>
