...
![原子節點：點陣](bitmap.resources/comp_bitmap.png "圖原子節點：點陣圖")
...
這個節點用來將點陣](../../../../glossary/glossary.md)圖匯入[你的圖表，或是建立新的點陣圖以配合[點陣圖繪製工具](../../../../resources/bitmap-resource/bitmap-painting-tools/bitmap-painting-tools.md)使用。
...
<div data-preserve-html="true" style="text-align: center;"><img src="bitmap.resources/bitmap-tooltip.gif" alt="點陣圖提示" /></div>
...
>[!TIP]
>
> 產生或匯入的 8 位元點陣圖可用 2D 視圖](../../../../interface/2d-view/2d-view.md)底座中的[點陣繪圖工具](../../../../resources/bitmap-resource/bitmap-painting-tools/bitmap-painting-tools.md)繪[製。
...
點陣圖可以在 Designer 中編輯。 在本節](../../../../resources/bitmap-resource/bitmap-painting-tools/bitmap-painting-tools.md)了解更多編輯工具[的資訊。
