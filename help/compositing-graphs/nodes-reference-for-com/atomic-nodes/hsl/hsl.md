...
![原子節點：HSL](hsl.resources/comp_hsl_1.png "原子節點：HSL"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="hsl.resources/hsl-tooltip.gif" alt="HSL 工具提示" /></div>
