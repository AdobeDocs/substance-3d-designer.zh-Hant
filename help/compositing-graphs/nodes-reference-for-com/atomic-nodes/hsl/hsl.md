...
![原子節點：HSL](hsl.resources/comp_hsl_1.png "原子節點：HSL"){width="100%"}
...
<td style="border: 0; text-align: center" align="center"><img src="hsl.resources/hsl-tooltip.gif" alt="HSL 工具提示" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
