...
<b>預覽</b> *色彩*&#x200B;將預覽合成於遮罩上方，幫助視覺化參數的效果。
...
<b>遮罩閾值</b>*浮點*&#x200B;遮罩</b>的灰階值<b>，用於分離形狀外部（遮&lt; Mask Threshold Value) and the inside (values >罩閾值值）。 

<b>Decimate Path</b> *Float*&#x200B;隱式控制將產生的區段數量。\
大量減取會使圓形形狀呈現某種多邊形，而若不減算，則會產生幾乎一個像素的區段。\
合理的數量能更好地匹配直線和曲線的形狀，而不會造成太多直線的中間點。

<b>關閉開啟路徑布</b> *林值*&#x200B;建立一條位於開放路徑起點與結束頂點之間的段。\
