...
![節點圖示](preview-paths.resources/preview-paths-icon.png "節點圖示")
...
![節點範例 1](preview-paths.resources/PathsToSpline-Variant2-Before_1.jpg "節點範例 1")

</td>
<td style="border: 0;" valign="top">

![節點範例 2](preview-paths.resources/PathsToSpline-Variant1-Before_1.jpg "節點範例 2")
