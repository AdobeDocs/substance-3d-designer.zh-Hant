...
![節點圖示](paths-vertex-processor-simple.resources/paths-vertex-processor-simple-icon.png "節點圖示")
...
![節點範例 2](paths-vertex-processor-simple.resources/PathsVertexProcessor-Demo2.gif "節點範例 2")
