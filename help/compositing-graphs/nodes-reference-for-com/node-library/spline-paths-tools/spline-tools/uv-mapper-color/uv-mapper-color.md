...
![節點圖示](uv-mapper-color.resources/uv-mapper-color-icon.png "節點圖示")
...
<table>
  <tr>
    <td>
      <img src="uv-mapper-color.resources/UVMapper-Variant1-Before.jpg" alt="UVMapper-變體1-之前">
      <br><i>之前</i>
    </td>
    <td>
      <img src="uv-mapper-color.resources/UVMapper-Variant1-After.jpg" alt="UVMapper-變體1-之後">
      <br><i>之後</i>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <img src="uv-mapper-color.resources/UVMapper-Variant2-Before.jpg" alt="UVMapper-變體2-之前">
      <br><i>之前</i>
    </td>
    <td>
      <img src="uv-mapper-color.resources/UVMapperColor-Variant2-After.jpg" alt="UVMapperColor-變體2-之後">
      <br><i>之後</i>
    </td>
  </tr>
</table>
...
![圖](uv-mapper-color.resources/UVMapperColor-Graph.jpg "中的節點圖中的節點")
