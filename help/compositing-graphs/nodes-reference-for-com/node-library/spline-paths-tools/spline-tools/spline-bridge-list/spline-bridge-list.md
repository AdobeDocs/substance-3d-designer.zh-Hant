...
<b>起始隨機偏移</b> *浮點*&#x200B;一個乘數，用於橋接樣條起始位置施加的隨機偏移，最大距離由<b>隨機偏移範圍</b>參數決定。

<b>結束隨機偏移</b> *浮點*&#x200B;一個乘數，用於橋接樣條端點位置的隨機偏移，最大距離由<b>隨機偏移範圍</b>參數決定。

<b>全域隨機偏移</b>*浮點*&#x200B;一個乘數，表示&#x200B;*橋式樣條的起始與結束位置施加**相同量*&#x200B;的隨機偏移量，最大距離由<b>隨機偏移範圍</b>參數決定。 
...
<b>厚度</b> *浮動*&#x200B;施加於橋式樣鍵的絕對厚度值。

<b>厚度隨機</b> *浮點*&#x200B;橋式樣鍵厚度的隨機乘數，該乘數的初始厚度由<b>厚度</b>模式參數指定。

+++

+++高度
<b>高度模式整</b> *數*&#x200B;取得橋式樣條高度值的方法。\
*- 繼承自父樣條曲線：*&#x200B;使用橋式樣條起始與結束位置的父樣條高度\
*- 覆寫：*&#x200B;使用你在高度</b>參數中<b>指定的任意值

<b>高度偏移</b> *浮點*&#x200B;指在套用到橋接樣條之前，對繼承自父樣條的高度所施加的偏移量。

<b>高度</b> *浮點*&#x200B;施加於橋樑樣條的絕對高度值。

<b>高度隨機</b> *浮動*&#x200B;對橋式樣條高度的隨機調整，該調整取決於所選<b>的高度模式</b>參數：\
*- 繼承自父樣條：*&#x200B;該值為繼承高度的乘數。\
*- 覆寫：*&#x200B;此值是高度的偏移量加分。
