---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/spline-paths-tools/spline-tools/spline-mapper-color.html"
breadcrumb-title: ''
description: 使用 Spline Mapper Color 節點，將色彩貼圖沿樣條路徑映射，並可自訂參數。
...
![節點圖示](spline-mapper-color.resources/spline-mapper-color-icon.png "節點圖示")
...
節點會輸出映射後的影像為彩色影像，並提供其他資訊，如高度、UV（即影像座標）及用於獨立選擇每個映射樣條的 ID 遮罩。
...
>[!NOTE]
>
> 另 [見樣條映射機灰階](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-mapper-grayscale/spline-mapper-grayscale.md)。
...
| <b>色彩地圖</b> <i>顏色</i> | 應該沿著輸入樣條映射的輸入色彩影像。 |
...
|  |  |
|:---|:---|
| <b>顏色</b> <i>顏色</i> | 將輸入的彩色影像映射到輸入樣條線，作為彩色影像的結果。 |
...
| <b>背景色</b> <i>Float4</i> | Color 輸出中背景的顏色。 |
...
<table>
  <tr>
    ...
    <td>
      <img src="spline-mapper-color.resources/SplineMapperColor-Variant1-After.jpg" alt="樣條貼圖變體1-之後">
      <br><i>之後</i>
    </td>
  </tr>
</table>
...
![節點範例 2](spline-mapper-color.resources/SplineMapperColor-Demo.gif "節點範例 2")
...
![節點範例 3](spline-mapper-color.resources/SplineMapperColor-Variant1-After1.jpg "節點範例 3")
