...
| <b>向量地圖位移</b> *浮標* | 利用從向量映射</b>輸入取<b>*樣的值*&#x200B;調整&#x200B;*對每個頂點施加的全域*&#x200B;位移量。此偏移&#x200B;*量會*&#x200B;與<b>隨機位置（Random Position</b>）和<b>五分位移（Quincux Offset</b>）參數堆疊。 |
| <b>五度偏移 X</b> *浮標* | 對每隔一排&#x200B;*頂點，依其**格子大小，套用指定的偏移*&#x200B;量。這個偏移 *量會* 與 <b>隨機位置</b> 和 <b>向量貼圖位移</b> 參數疊加。 |
| <b>Quincux 偏移 Y</b> *浮標* | 將指定的偏移量套用 *到每隔一欄* 頂點，相對於 *其在網格中的格* 子大小。此偏移 *量會* 與 <b>隨機位置</b> 和 <b>向量圖位移</b> 參數疊加。 |
| <b>旋轉</b> *浮標* | 對每個頂點&#x200B;*在其基準位置*（即隨機偏移與位移前&#x200B;*的位置*）施加&#x200B;*指定的*&#x200B;旋轉量。此旋轉&#x200B;*與*<b>旋轉無序</b>參數疊加。 |
| <b>旋轉失調</b> *浮標* | 對每個頂點&#x200B;*在其基準位置*&#x200B;周圍施加&#x200B;*隨機*&#x200B;旋轉量——即在隨機偏移與位移施加&#x200B;*前的位置*。此旋轉&#x200B;*與旋轉</b>參數堆*<b>疊。 |
| <b>高度輸入倍數</b> *浮標* | 利用從 Height</b> 輸入取樣的&#x200B;*<b>值*&#x200B;調整每個頂點的 Z 位置。這個偏移&#x200B;*會*&#x200B;與 <b>Height Random</b> 參數堆疊。 |
