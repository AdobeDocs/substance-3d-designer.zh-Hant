...
**Grunge Galvanic Large** 節點會產生類似鍍鋅鋼圖案的 grunge 地圖。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-galvanic-large.resources/grungegalvaniclarge-variant.jpg" class="modal-image" alt="Grunge Galvanic Large - 範例 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-galvanic-large.resources/grungegalvaniclarge-variant2.jpg" class="modal-image" alt="Grunge Galvanic Large - 範例 2" />
        </td>
