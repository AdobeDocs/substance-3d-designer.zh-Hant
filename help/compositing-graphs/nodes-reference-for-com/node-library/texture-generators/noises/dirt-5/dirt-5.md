---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-5.html"
breadcrumb-title: ""
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-5.resources/dirt_5_1.png" class="modal-image" alt="泥土5 - 範例1" />
        </td>
        <td style="border: 0;">
            <img src="dirt-5.resources/noise_dirt_5_v2_speed0.6_aniso0.gif" class="modal-image" alt="泥土5 - 範例2" />
        </td>
        <td style="border: 0;">
            <img src="dirt-5.resources/noise_dirt_5_v2_speed0.6_aniso1.gif" class="modal-image" alt="泥土5 - 範例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-5.resources/noise_dirt_5_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="泥土5 - 範例4" />
        </td>
