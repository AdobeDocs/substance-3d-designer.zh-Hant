...
![BnW 1 - 圖示](bnw-spots-1.resources/bnw_spots_1.png "BnW 地點 1 - 圖示"){width="200px"}
...
| <b>粗糙度</b> <i>浮標</i> | 噪音八度的平衡，當值越高，高頻八度就越明顯。 |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/bnw_spots_1_1.png" class="modal-image" alt="BnW 點數 1 - 範例 1" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="BNW 地點 1 - 範例 2" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.6_aniso1.gif" class="modal-image" alt="BNW點1 - 範例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="BNW地點1 - 範例4" />
        </td>
