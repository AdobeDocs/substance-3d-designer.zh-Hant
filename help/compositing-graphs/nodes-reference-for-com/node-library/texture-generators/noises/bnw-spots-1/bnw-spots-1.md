...
![BnW 地點 1 - 範例 1](bnw-spots-1.resources/bnw_spots_1_1.png "BnW 地點 1 - 範例 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![BnW 地點 1 - 範例 2](bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.6_aniso0.gif "BnW 地點 1 - 範例 2"){zoomable="yes"}
...
![BnW 點 1 - 範例 3](bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.6_aniso1.gif "BnW 點 1 - 範例 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![BNW點1 - 範例4](bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.3_aniso0.6.gif "BnW點1 - 範例4"){zoomable="yes"}
