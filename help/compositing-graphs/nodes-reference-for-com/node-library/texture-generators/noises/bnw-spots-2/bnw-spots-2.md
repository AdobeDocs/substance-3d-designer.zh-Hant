...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/bnw_spots_2_1.png" class="modal-image" alt="BNW點數2 - 範例1" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="BnW 的點數 2 - 範例 2" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso1.gif" class="modal-image" alt="BnW 點數 2 - 範例 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="BNW點數2 - 範例4" />
        </td>
