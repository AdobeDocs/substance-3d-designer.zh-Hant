---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/grunge-map-009.html"
breadcrumb-title: ""
description: 使用 Grunge Map 009 節點生成程序化垃圾紋理，為材質添加表面細節和磨損效果。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-009.resources/grungemap-009-ex.gif" class="modal-image" alt="垃圾搖滾地圖 009 - 範例 1" />
        </td>
