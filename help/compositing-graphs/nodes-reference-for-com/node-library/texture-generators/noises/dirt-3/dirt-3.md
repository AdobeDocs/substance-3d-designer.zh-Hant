...
![泥土3 - 圖示](dirt-3.resources/dirt_3.png "泥土3 - 圖示"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-3.resources/dirt_3_1.png" class="modal-image" alt="泥土3 - 範例1" />
        </td>
        <td style="border: 0;">
            <img src="dirt-3.resources/noise_dirt_3_v2_speed0.6_aniso0.gif" class="modal-image" alt="泥土3 - 範例2" />
        </td>
        <td style="border: 0;">
            <img src="dirt-3.resources/noise_dirt_3_v2_speed0.6_aniso1.gif" class="modal-image" alt="泥土3 - 範例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-3.resources/noise_dirt_3_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="泥土3 - 範例4" />
        </td>
