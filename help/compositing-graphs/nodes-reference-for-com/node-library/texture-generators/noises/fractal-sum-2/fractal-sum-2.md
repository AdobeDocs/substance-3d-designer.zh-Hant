...
![分形和 2 - 圖示](fractal-sum-2.resources/fractal-sum-2-01.png "分形和 2 - 圖示"){width="200px"}
...
![分形和 2 - 範例 1](fractal-sum-2.resources/fractal-sum-2-02.png "分形和 2 - 範例 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![分形和 2 - 範例 2](fractal-sum-2.resources/fractal-sum-2-03.gif "分形和 2 - 範例 2"){zoomable="yes"}
