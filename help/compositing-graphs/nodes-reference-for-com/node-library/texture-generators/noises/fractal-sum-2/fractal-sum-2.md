---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/fractal-sum-2.html"
breadcrumb-title: ""
description: 使用 Fractal Sum 2 節點產生帶有兩個八度的分形雜訊，以創造有機的紋理變化。
...
![分形和 2 - 圖示](fractal-sum-2.resources/fractal_sum_2.png "分形和 2 - 圖示"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="fractal-sum-2.resources/fractal_sum_2_1.png" class="modal-image" alt="分形和 2 - 範例 1" />
        </td>
        <td style="border: 0;">
            <img src="fractal-sum-2.resources/noise_fractal_sum_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="分形和 2 - 範例 2" />
        </td>
