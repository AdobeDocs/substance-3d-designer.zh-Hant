...
**Grunge Leaks** 節點會產生一張類似油膩表面滴落的 grunge 地圖。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-leaks.resources/grungeleaks-variant2.jpg" class="modal-image" alt="垃圾搖滾洩漏 - 範例一" />
        </td>
        <td style="border: 0;">
            <img src="grunge-leaks.resources/grungeleaks-variant.jpg" class="modal-image" alt="垃圾搖滾洩漏 - 範例二" />
        </td>
