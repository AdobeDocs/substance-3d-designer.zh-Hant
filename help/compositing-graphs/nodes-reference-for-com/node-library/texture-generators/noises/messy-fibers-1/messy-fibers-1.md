---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/messy-fibers-1.html"
breadcrumb-title: ""
...
![混亂的纖維 1 - 圖示](messy-fibers-1.resources/messy_fibers_1.png "混亂的纖維 1 - 圖示"){width="200px"}
...
| <b>路線編號</b> <i>浮標</i> | 底線鋪磚量較高，線材密度越高且較細。 |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/messy_fibers_1_1.png" class="modal-image" alt="混亂纖維 1 - 圖示" />
        </td>
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.gif" class="modal-image" alt="雜亂纖維1 - 範例2" />
        </td>
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso1.gif" class="modal-image" alt="雜亂纖維 1 - 範例 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.6.gif" class="modal-image" alt="雜亂纖維 1 - 範例 4" />
        </td>
