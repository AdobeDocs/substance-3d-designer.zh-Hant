...
![混亂的纖維 1 - 圖示](messy-fibers-1.resources/messy_fibers_1_1.png "混亂的纖維 1 - 圖示"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![雜亂纖維1 - 範例2](messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.gif "雜亂纖維1 - 範例2"){zoomable="yes"}
...
![混亂纖維1 - 範例3](messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso1.gif "混亂纖維1 - 範例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![混亂纖維 1 - 範例 4](messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.6.gif "混亂纖維 1 - 範例 4"){zoomable="yes"}
