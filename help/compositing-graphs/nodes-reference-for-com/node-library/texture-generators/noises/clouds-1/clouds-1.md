---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/clouds-1.html"
breadcrumb-title: ""
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="clouds-1.resources/clouds_1_1.png" class="modal-image" alt="雲 1 - 範例 1" />
        </td>
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="雲 1 - 範例 2" />
        </td>
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso1.gif" class="modal-image" alt="雲 1 - 範例 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="雲 1 - 範例 4" />
        </td>
