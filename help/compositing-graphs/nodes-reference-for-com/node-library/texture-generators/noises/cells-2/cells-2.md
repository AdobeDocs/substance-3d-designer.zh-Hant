...
![格子 2 - 圖示](cells-2.resources/cells-2-01.png "格子 2 - 圖示"){width="200px"}
...
![格子 2 - 範例 1](cells-2.resources/cells-2-02.png "格子 2 - 範例 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![格子 2 - 範例 2](cells-2.resources/cells-2-03.gif "格子 - 範例 2"){zoomable="yes"}
