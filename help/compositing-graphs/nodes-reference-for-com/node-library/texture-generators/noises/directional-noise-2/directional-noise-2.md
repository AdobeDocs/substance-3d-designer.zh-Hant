...
![方向性雜訊2 - 範例1](directional-noise-2.resources/directional_noise_2_1.png "方向性雜訊2 - 範例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性雜訊 2 - 範例 2](directional-noise-2.resources/noise_directional_noise_2_v2_speed0.6_aniso0.gif "方向性雜訊 2 - 範例 2"){zoomable="yes"}
...
![方向性噪音2 - 範例3](directional-noise-2.resources/noise_directional_noise_2_v2_speed0.6_aniso1.gif "方向性噪音2 - 範例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性噪音 2 - 範例 4](directional-noise-2.resources/noise_directional_noise_2_v2_speed0.3_aniso0.6.gif "方向性噪音 2 - 範例 4"){zoomable="yes"}
