...
breadcrumb-title: ''
description: 在 Substance 3D Designer 中存取材料的轉換節點，以修改材料輸出並進行轉換。
...
此類別包含旨在轉化完整多通道材料的節點。 目前只 [包含材質轉換](../../../../../compositing-graphs/nodes-reference-for-com/node-library/material-filters/transforms-material/material-transform/material-transform.md)。
