...
![各向異性桑原灰階圖示 各向異性桑原灰階圖示](anisotropic-kuwahara-gra.resources/anisotropic_kuwahara_grayscale.png ""){width="200px"}
...
![一碗裝有桑原濾鏡、各向異性為零的水果。](anisotropic-kuwahara-gra.resources/anisotropic_kuwahara_gray_example_3_before.jpg){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![一碗裝有桑原濾鏡、各向異性為零的水果。](anisotropic-kuwahara-gra.resources/anisotropic_kuwahara_gray_example_3_after.jpg){zoomable="yes"}
