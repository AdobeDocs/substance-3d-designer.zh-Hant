...
![「絕對」繼承方法](inheritance-in-substance-compositing-graphs.resources/ds-inheritance-absolute.png "圖示 「絕對」繼承方法圖示"){width="128px"}
...
![「相對於輸入」繼承方法](inheritance-in-substance-compositing-graphs.resources/ds-inheritance-relative-to-input.png "的圖示 「相對於輸入」繼承方法的圖示"){width="128px"}
...
![相對於父繼承方法的圖示 相對於父繼承方法](inheritance-in-substance-compositing-graphs.resources/ds-inheritance-relative-to-parent.png "的圖示"){width="128px"}
...
![繼承方法示範繼](inheritance-in-substance-compositing-graphs.resources/inheritance-overview.gif "承方法示範")
...
>[!NOTE]
>
> **輸出大小：**&#x200B;使用![](inheritance-in-substance-compositing-graphs.resources/props-output-size-lock.jpg)鎖定鍵讓高度值&#x200B;*與寬度值相符*\
> **隨機種子：** 使用 ![](inheritance-in-substance-compositing-graphs.resources/prop-randomise.jpg) 按鈕為隨機種子指派新的隨機值。
...
![變更繼承方法](inheritance-in-substance-compositing-graphs.resources/inheritance-change.gif "變更繼承方法"){width="512px"}
...
![主要輸入色彩/灰階](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input-both.png){width="48px"}

</td>
<td style="border: 0;" valign="top">

![主要輸入色](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input-color.png){width="48px"}

</td>
<td style="border: 0;" valign="top">

![主要輸入灰階](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input-grayscale.png){width="48px"}
...
![輸入連接器類型](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input.jpg "輸入連接器類型")
...
![繼承圖 繼](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-a.png "承圖 A"){zoomable="yes"}
...
![繼承圖B](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-b.png "繼承圖 B"){zoomable="yes"}
...
![繼承圖 C](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-c.png "繼承圖 C"){zoomable="yes"}
...
![繼承圖 D](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-d.png "繼承圖 D"){zoomable="yes"}
...
![輸出大小繼承](inheritance-in-substance-compositing-graphs.resources/inheritance-blend.jpg "輸出大小繼承"){width="512px"}
