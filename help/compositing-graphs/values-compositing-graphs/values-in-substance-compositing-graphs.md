...
![輸出值節點](values-in-substance-compositing-graphs.resources/values-in-substance-compositing-graphs-03.gif "輸出值節點"){width="512px"}
...
![在節點](values-in-substance-compositing-graphs.resources/values-in-substance-compositing-graphs-04.gif "上加入輸入值 在節點上加入輸入值")
...
![與價值觀](values-in-substance-compositing-graphs.resources/values-in-substance-compositing-graphs-05.png "共事")
