...
![載入/儲存預設下拉選單](parameter-presets.resources/parameter-presets-01.gif "載入/儲存預設下拉選單"){width="512px"}
...
![嵌入預設](parameter-presets.resources/parameter-presets-02.gif "編輯 嵌入預設編輯"){width="512px"}
