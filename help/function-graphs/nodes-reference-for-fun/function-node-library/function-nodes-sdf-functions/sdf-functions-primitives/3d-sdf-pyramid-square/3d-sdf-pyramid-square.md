---
title: 金字塔方陣
description: Designer > Substance 合成圖 > Nodes 參考 Substance 合成圖 > Node 函式庫 > SDF 函式 > Primitive > Pyramid 方格
...
![金字塔方形圖示](./3d-sdf-pyramid-square.png "金字塔方形")
...
| <b>底座尺寸</b> *浮標* | 金字塔底部邊緣的長度。<br>所有邊長度相等。<br><br><i>預設值：1</i> |
