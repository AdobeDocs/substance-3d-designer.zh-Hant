...
![實體函數圖](the-function-graph.resources/the-function-graph-01.png "實質函數圖")
...
![Substance 函數圖節點列表](the-function-graph.resources/the-function-graph-02.png "Substance 函數圖節點列表")
...
![物質函數圖的輸出節點](the-function-graph.resources/the-function-graph-03.png "實質函數圖的輸出節點")
...
![定義輸出節點](the-function-graph.resources/the-function-graph-04.gif "定義輸出節點")
...
![開放參照的實質函數圖](the-function-graph.resources/the-function-graph-05.png "開放參照的實質函數圖")
...
![從套件](the-function-graph.resources/the-function-graph-06.gif "中移除物質函數圖 從套件中移除物質函數圖")
