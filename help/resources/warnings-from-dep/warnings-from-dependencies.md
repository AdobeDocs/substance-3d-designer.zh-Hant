...
1. <b>成功讓相依載入成功</b>
   ...
   ![「無效相依套件」解決方案 1](warnings-from-dependencies.resources/warnings-dep-invalid-dependent-pkg.gif "&#39;無效相依套件」解決方案 1")
1. <b>重新定位套件中的相依</b>
   ...
   ![「無效相依套件」解決方案 2](warnings-from-dependencies.resources/warnings-dep-invalid-dependent-pkg-2.gif "&#39; 無效相依套件」解決方案 2")
...
![「檢查別名已定義」解](warnings-from-dependencies.resources/warnings-dep-alias.gif "答「檢查別名已定義」解法")
...
1. <b>還原檔案</b>
   ...
   ![「沒有檔案匹配資源」解決方案1](warnings-from-dependencies.resources/warnings-dep-udim-2.gif "「沒有檔案匹配資源」解決方案1")
1. <b>重新定位檔案</b>
   ...
   ![「沒有符合資源的檔案」解決方案2](warnings-from-dependencies.resources/warnings-dep-udim.gif "「沒有符合資源的檔案」解決方案2")
...
1. <b>還原檔案</b>
   ...
   ![「找不到連結檔案」解決方案 1](warnings-from-dependencies.resources/warnings-dep-file-not-found.gif "&#39;找不到連結檔案」解決方案 1")
1. <b>重新定位檔案</b>

   如果檔案被移動或重新命名，請在檔案總管[&#128279;](../../interface/the-explorer-window/the-explorer-window.md)面板中點擊資源項目的 RMB，並選擇<b>重新定位</b>選項，將該資源連結到同類型的另一個檔案。

   ![「找不到連結檔案」解決方案 2](warnings-from-dependencies.resources/warnings-dep-file-not-found-2.gif "&#39;找不到連結檔案」解決方案 2")
...
![「找不到色彩空間」的解](warnings-from-dependencies.resources/warnings-dep-color-space.gif "法「找不到色彩空間」的解法")
...
1. <b>還原該圖</b>
   ...
   ![「找不到參考資源」解決方案 1](warnings-from-dependencies.resources/warnings-dep-udim-graph-2.gif "&#39;找不到參考資源」解決方案 1")
1. <b>選擇另一張圖</b>

   在套件中再指派一個圖給 UV 圖塊。

   ![「找不到參考資源」解決方案 1](warnings-from-dependencies.resources/warnings-dep-udim-graph.gif "&#39;找不到參考資源」解決方案 2")
...
![「UV圖塊被多次指派」解](warnings-from-dependencies.resources/warnings-dep-udim-same.gif "法「UV圖塊被多次指派」解法")
...
![「無效 UV 圖塊」解決方案](warnings-from-dependencies.resources/warnings-dep-udim-invalid.gif "「無效 UV 圖塊」解決方案")
