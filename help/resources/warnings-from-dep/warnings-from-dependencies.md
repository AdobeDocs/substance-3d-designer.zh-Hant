...
1. <b>重新定位套件中的相依</b>
   ...
   你可以用 [依賴管理器](../../interface/dependency-manager/dependency-manager.md) 重新定位相依。 在檔案總管](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)面板中，C 舔 主機套件[的 RMB，然後在情境選單中選擇<b>相依性管理器</b>選項。
...
## ![（錯誤）](../../assets/error.svg)請檢查你的專案中定義了別名&#x200B;*「X」*
...
![「檢查別名已定義」解](../../assets/warnings-dep-alias.gif "答「檢查別名已定義」解法")

## ![（錯誤）](../../assets/error.svg)找不到與此資源相符的檔案
...
1. <b>重新定位檔案</b>
   ...
   若檔案被移動或重新命名，請在檔案總管](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)面板中點擊資源項目[的 RMB 鍵，選擇<b>「重新定位</b>」選項，將該資源連結到&#x200B;*同一類型 UDIM 映像檔*&#x200B;中的第一個檔案。

   ![「沒有符合資源的檔案」解決方案2](../../assets/warnings-dep-udim.gif "「沒有符合資源的檔案」解決方案2")

## ![（錯誤）](../../assets/error.svg)找不到連結檔案
...
1. <b>重新定位檔案</b>
   ...
   如果檔案被移動或重新命名，請在檔案總管](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)面板中點擊資源項目[的 RMB，並選擇<b>重新定位</b>選項，將該資源連結到同類型的另一個檔案。

   ![「找不到連結檔案」解決方案 2](../../assets/warnings-dep-file-not-found-2.gif "&#39;找不到連結檔案」解決方案 2")

## ![（錯誤）](../../assets/error.svg)找不到色彩空間
...
![「找不到色彩空間」的解](../../assets/warnings-dep-color-space.gif "法「找不到色彩空間」的解法")

## ![（錯誤）](../../assets/error.svg)找不到參考資源

分配給 3D 網格](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/3d-mesh-resource-200574577.html)資源 UV 圖塊[的圖形，無法在警告中報告的位置找到。
...
1. <b>選擇另一張圖</b>
   ...
   ![「找不到參考資源」解決方案 1](../../assets/warnings-dep-udim-graph.gif "&#39;找不到參考資源」解決方案 2")

## ![（錯誤）](../../assets/error.svg)UV 圖塊會被多次指定

3D 網格資源](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/3d-mesh-resource-200574577.html)的 UV 圖塊[會被多次指派到 [Substance 圖](../../compositing-graphs/substance-compositing-graphs.md)。

<b>![（勾選）](../../assets/check.svg）解決方案</b>

對於每個 3D 網格資源的 UV 集合，請確保 UV 圖塊</b>列表中沒有重複<b>*出現的 UDIM 索引*。

![「UV圖塊被多次指派」解](../../assets/warnings-dep-udim-same.gif "法「UV圖塊被多次指派」解法")
...
![「無效 UV 圖塊」解決方案](../../assets/warnings-dep-udim-invalid.gif "「無效 UV 圖塊」解決方案")
