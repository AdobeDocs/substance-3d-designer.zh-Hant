...
點陣圖資源是物質套件中的一個資源。 它與 [原子點陣節點不同。 原子點陣節點](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/bitmap/bitmap.md)是該位圖在 Substance 圖[&#128279;](../../compositing-graphs/substance-compositing-graphs.md)中的特定表示。
...
點陣圖在 SBS 中如何儲存取決於你 [是用連結還是匯入，先確定你熟悉這個概念。](../../resources/importing-linking-and-new/importing-linking-and-new-resources.md) 匯入的點陣圖可以用點陣圖繪製工具[&#128279;](../../resources/bitmap-resource/bitmap-painting-tools/bitmap-painting-tools.md)進行編輯。
