...
![從材質輸入建立圖形 - 在「3D View」視窗](extracting-materials-values-and-textures.resources/createGraphFromTexturesActionViewport.png "中操作 從材質輸入建立圖形 - 在「3D View」視窗中操作"){zoomable="yes"}
...
![從材質輸入建立圖表 - 在「材質」選單](extracting-materials-values-and-textures.resources/createGraphFromTexturesActionMaterials.png "中的動作 從材質輸入建立圖表 - 在「材質」選單中的動作"){zoomable="yes"}
...
![從材質輸入建立圖表 - 在「屬性」底座](extracting-materials-values-and-textures.resources/createGraphFromTexturesActionProps.png "中的動作 從材質輸入建立圖表 - 在「屬性」底座中的動作"){zoomable="yes"}
...
![從材質材質建立圖的結果 從材質材質](extracting-materials-values-and-textures.resources/createGraphFromTexturesResult.png "材質建立圖的結果"){zoomable="yes"}

*從材質紋理建立圖的結果*

+++示範
![從貼圖輸入建立圖形 - 示範](extracting-materials-values-and-textures.resources/createGraphFromTextures.gif "從貼圖輸入建立圖形 - 示範"){zoomable="yes"}
...
![從 Properties Dock 中擷取貼圖 - 在 Properties Dock](extracting-materials-values-and-textures.resources/extractTextureAction.png "中執行動作 將 擷取到圖表 - 在 Properties Dock 中執行"){zoomable="yes"}
...
![將貼圖擷取到圖表 - 「選擇目的地圖表」對話框](extracting-materials-values-and-textures.resources/extractTextureSelectGraph.png "將貼圖擷取到圖表 - 「選擇目的地圖表」對話框"){zoomable="yes"}
...
![紋理萃取](extracting-materials-values-and-textures.resources/extractTextureResult.png "的結果 紋理萃取的結果"){zoomable="yes"}

紋理提取的結果

+++示範
![從貼圖擷取貼圖 - 示範](extracting-materials-values-and-textures.resources/extractTextureToGraph.gif "擷取貼圖至圖 - 示範"){zoomable="yes"}
...
![擷取到圖的值 - 在屬性掛鉤](extracting-materials-values-and-textures.resources/extractValueAction.png "中的動作 從圖中提取到圖的值 - 在屬性停靠中的動作"){zoomable="yes"}
...
![將值抽取到圖 - 「選擇目標圖」對話框](extracting-materials-values-and-textures.resources/extractValueSelectGraph.png "擷取到圖的值 - 「選擇目標圖」對話框"){zoomable="yes"}
...
![擷取圖中的值 - 值處理器節點函式](extracting-materials-values-and-textures.resources/extractValueResult2.png "中的常數節點 擷取圖中的值 - 值處理器節點函式中的常數節點"){zoomable="yes"}
...
![價值萃取](extracting-materials-values-and-textures.resources/extractValueResult.png "的結果 價值萃取的結果"){zoomable="yes"}

價值提取的結果

+++示範
![擷取圖的值 - 示範](extracting-materials-values-and-textures.resources/extractValueToGraph.gif "擷取圖的值 - 示範"){zoomable="yes"}
