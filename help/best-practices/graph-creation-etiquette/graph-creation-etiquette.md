...
![實體圖](graph-creation-etiquette.resources/frames.gif "中的框架 實質圖中的框架")
...
![輸入與輸出配置](graph-creation-etiquette.resources/inout.gif "輸入與輸出配置")
...
![連結重路由](graph-creation-etiquette.resources/linkjreroute.gif "連結重新路由")
...
![識別碼與標籤](graph-creation-etiquette.resources/output-label.png "識別碼與標籤")

盡量不要讓識別碼和標籤差異太大：如果識別碼在其他地方（多個函式中）被使用，就很難找到哪個 UI 屬性對應哪個變數。

![識別碼清晰](graph-creation-etiquette.resources/labelvsidentifier.png "度識別碼清晰度")

試著讓你的標籤與你在框架（框架標籤）和評論中使用的詞彙相符。 這樣比較容易找出圖表中哪個區段連結到哪個暴露的參數

![匹配框架與參數標籤匹配](graph-creation-etiquette.resources/match-labels.png "框架與參數標籤")
...
![彩色與灰階轉換](graph-creation-etiquette.resources/colorgray01.png "彩色與灰階轉換")
