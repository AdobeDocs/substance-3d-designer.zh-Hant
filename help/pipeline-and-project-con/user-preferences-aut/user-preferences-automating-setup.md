...
![XML 檔案圖示](user-preferences-automating-setup.resources/xml-5.png "XML 檔案圖示")
...
![專案設定](user-preferences-automating-setup.resources/preferences-ui.png "專案設定")
...
![設定檔輸入於可執行檔屬性](user-preferences-automating-setup.resources/shortcutargument.jpg "中")
