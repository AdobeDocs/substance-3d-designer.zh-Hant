...
| <b>OCIO</b> | 使用OpenColorIO [色彩管理](../../color-management/color-management.md)時應使用的OCIO設定檔路徑。 覆蓋 Designer 在專案設定](../../interface/preferences-window/project-settings/project-settings.md)中色彩管理設定[中的路徑設定。 |
