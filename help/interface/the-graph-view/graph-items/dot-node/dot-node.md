...
![點節點圖示](dot-node.resources/dot-node-01.png "點點節點圖示")
...
![插入點點](dot-node.resources/dot-node-02.gif ""){width="512px"}
...
![點：從連接器](dot-node.resources/dot-node-03.gif "創建 點：從連接器創建")
...
![節點選單](dot-node.resources/dot-node-04.png "中的點節點選單中的節點")
...
![合併連結](dot-node.resources/dot-node-05.gif "合併連結"){width="512px"}
...
![點節點作為入口 - 圖示](dot-node.resources/dot-node-06.png "點節點作為入口 - 圖示")
...
![點節點作為入口](dot-node.resources/dot-node-07.gif "點節點作為入口")
