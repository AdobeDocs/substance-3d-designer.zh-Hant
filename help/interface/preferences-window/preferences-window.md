...
![偏好設定視窗](preferences-window.resources/image2021-6-22-20-56-1.png "偏好設定視窗")
...
![禁用](preferences-window.resources/substance3ddesigner_incontext_no.gif "上下文編輯 關閉上下文編輯")
...
![啟用](preferences-window.resources/substance3ddesigner_incontext_yes.gif "上下文編輯 啟用上下文編輯 啟用上下文編輯")
