...
屬性面板也會回應檔案總管視窗[&#128279;](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)中的選擇變更。它可以作為選擇圖表的另一種方式（而不是雙擊空白區域），也能讓你更改 Package 和 [Resource](../../resources/resources.md)屬性。
