...
這個選單讓你管理 Designer 的主要使用者介面元素。 每個選項都在<b>本頁](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-main-menu-143720673.html) Windows</b> 主工具列的部分[說明。在這裡，我們將提供與此菜單相關的額外概念。
