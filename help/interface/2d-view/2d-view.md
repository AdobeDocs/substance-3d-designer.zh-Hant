...
![2D 視圖](../../assets/2d-view-main.png "2D 視圖")
...
*多個* 2D 檢視面板可隨時啟用，且每個面板可顯示不同的影像或數值。 你可以透過![](../../assets/2d-view-icon-pin.png)<b>使用者介面面板的針腳</b>功能來控制何時使用新的面板。
...
* <b>調整以符合視窗：</b> F / 「調整到視窗」按鈕![](../../assets/2d-view-icon-fit-to-view.png)
* <b>調整到 1：1 比例：</b> Z / 「合適比例」按鈕![](../../assets/2d-view-icon-fit-to-scale.png)

</td>
<td style="border: 0;" valign="top">

![2D 視窗導覽](../../assets/2d-view-viewport-navigation.gif "2D 視窗導覽")
...
+++背景影像
![2D 查看背景圖片](../../assets/2d-view-background.png "2D 查看背景圖片"){width="360px"}



你可以 *在目前顯示的圖片上疊加不同的圖片* 。 按下![](../../assets/2d-view-icon-background.png)<b>背景圖片</b>按鈕，系統會提示您選擇一個圖片檔案作為覆蓋層。

選擇檔案後，會出現一個新工具列，並包含以下影像覆蓋控制：

<b>![](../../assets/2d-view-icon-background-close.png)關閉：</b> *關閉*&#x200B;覆蓋層控制工具列，並&#x200B;*關閉*&#x200B;背景圖片覆蓋。

<b>![](../../assets/2d-view-icon-background-loadpng.png)載入圖片：</b> 選擇&#x200B;*另一個圖片檔案*&#x200B;作為覆蓋層使用。

<b>![](../../assets/2d-view-icon-background-0.png)來源影像：</b> 將覆蓋影像設定為 *0%* 不透明度。

<b>![](../../assets/2d-view-icon-background-100.png)背景圖片：</b> 將覆蓋圖設定為 *100%* 不透明度。

<b>![](../../assets/2d-view-icon-background-50.png)重置：</b> 將覆蓋影像設定為 *50%* 透明度。
...
+++匯出影像
![2D 檢視匯出圖片](../../assets/2d-view-export-bitmap.png "2D 檢視匯出圖片"){width="360px"}



目前顯示的圖片可以 *匯出成圖片檔案*。 按下![](../../assets/2d-view-icon-export.png)<b>儲存影像......</b>按鈕，系統會提示您選擇&#x200B;*匯出檔案的位置*、*名稱*&#x200B;和&#x200B;*檔案格式*。
...
+++複製到夾板
![2D 檢視複製到剪貼簿](../../assets/2d-view-copy-clipboard.gif "2D 檢視複製到剪貼簿"){width="360px"}



目前顯示的圖片可以 *複製到剪貼板*。 按下![](../../assets/2d-view-icon-copy.png)<b>「複製圖片到剪貼簿</b>」按鈕，圖片即可貼上到任何第三方軟體，例如 Adobe Photoshop。
...
+++切換圖輸出
![2D 視圖切換圖輸出](../../assets/2d-view-switch-graph-outputs.gif "2D 視圖切換圖輸出"){width="360px"}



如果目前顯示的影像是圖形輸出&#x200B;*，你可以*&#x200B;透過<b>![](../../assets/2d-view-icon-view-outputs.png)選擇輸出</b>按鈕快速切換到任何其他&#x200B;*圖形*&#x200B;輸出。
...
+++紫外線覆蓋
![2D 視圖 UV 覆蓋](../../assets/2d-view-uv.png "2D 視圖 UV 覆蓋"){width="357px"}
...
+++圖片資訊
![2D 查看影像資訊](../../assets/2d-view-information.png "2D 查看影像資訊"){width="360px"}



你可以透過資訊面板顯示&#x200B;*影像中的精確像素值**和座標*，該面板是透過![](../../assets/2d-view-icon-information.png)<b>影像資訊</b>按鈕啟用的。</b> <b>這在檢查 HDR 影像時非常有用，或確保像素間的移動符合預期的進展。
...
+++直方圖
![2D 檢視直方圖](../../assets/2d-view-histogram.png "2D 檢視直方圖"){width="360px"}



你可以用<b>直方圖</b>面板顯示&#x200B;*影像的直方圖*，該面板是透過![](../../assets/2d-view-icon-histogram.png)<b>顯示直方圖</b>按鈕啟用的。
...
![2D 查看色彩通道](../../assets/2d-view-color-channel.png "2D View 色彩通道"){width="360px"}

### 彩色通道

你可以用![](../../assets/2d-view-icon-channels.png)<b>「色彩通道」</b>按鈕顯示圖片的單一通道。這會開啟一個組合框，讓你選擇顯示紅<b></b>、<b>綠</b><b>、藍</b><b>和阿爾法</b>四個頻道。透過選擇 <b>RGB</b> 選項，所有通道影像的正常畫面會被恢復。
...
透明度顯示可以透過 / <b>![](../../assets/2d-view-icon-transparency-on.png) 顯示棋盤格</b>按鈕開關![](../../assets/2d-view-icon-transparency-off.png)。啟用此功能後，透明度會以棋盤格圖案顯示。

有兩種主要的透明度解讀方式，可以透過 /![](../../assets/3d-view-icon-transparency-premultiplied.png) <b>透明度模式</b>按鈕選擇![](../../assets/2d-view-icon-transparency-straight.png)：

<b>![](../../assets/2d-view-icon-transparency-straight.png)直線：</b> 透明度資訊僅儲存在 alpha 通道中，不影響影像的其他部分

<b>![](../../assets/3d-view-icon-transparency-premultiplied.png)預乘法：</b> 透明度資訊儲存在 alpha 通道中，且同時影響 RGB 通道，因為它們實際上是與 alpha 通道相乘

為了顯示&#x200B;**&#x200B;正確的顏色，應在 <b>2D 檢視</b>面板中選擇適當的透明度模式，以符合影像創建&#x200B;**&#x200B;時所套用的透明度方法。

![2D 查看色彩空間](../../assets/2d-view-viewport-color-space.png "2D 查看色彩空間"){width="360px"}
...
![2D 視圖繪製工具](../../assets/2dview-paintingtools-main.png "2D 視圖繪製工具")
...
>[!TIP]
>
> 你可以在 [文件中的點陣繪製編輯器](https://helpx.adobe.com/tw/substance-3d/unlisted/documentation/sddoc/bitmap-painting-editor-102400057.html) 頁面了解更多。
...
![2D 顯示向量圖形編輯器](../../assets/2dview-vectorediting-main.png "2D 檢視向量圖形編輯器")
...
>[!TIP]
>
> 你可以在 [文件中的向量圖形編輯器（已棄用）](https://helpx.adobe.com/tw/substance-3d/unlisted/documentation/sddoc/vector-graphic-editor-deprecated-102400059.html) 頁面了解更多。

![2D 檢視色彩管理](../../assets/2d-view-color-management-ocio.png "2D 檢視色彩管理"){width="360px"}
