---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-designer/interface/2d-view.html"
breadcrumb-title: ''
...
![2D 視圖](2d-view.resources/2d-view-01.png "2D 視圖")
...
*多個* 2D 檢視面板可隨時啟用，且每個面板可顯示不同的影像或數值。 你可以透過![](2d-view.resources/2d-view-02.png)<b>使用者介面面板的針腳</b>功能來控制何時使用新的面板。
...
* <b>調整以符合視窗：</b> F / 「調整到視窗」按鈕 ![](2d-view.resources/2d-view-04.png)
* <b>調整到 1：1 比例：</b> Z / 「合適比例」按鈕 ![](2d-view.resources/2d-view-05.png)

</td>
<td style="border: 0;" valign="top">

![2D 視窗導覽](2d-view.resources/2d-view-06.gif "2D 視窗導覽")
...
* 平鋪顯示： *在視窗中以平鋪模式重複影像* 。 這有助於檢查圖案或質地的重複效果。 可透過&#x200B;**空白鍵**&#x200B;或![](2d-view.resources/2d-view-07.png)**平貼顯示**&#x200B;按鈕啟用
* 實體尺寸顯示：顯示與&#x200B;*圖形物理尺寸[&#128279;](../../compositing-graphs/graph-parameters/graph-parameters.md)屬性相符的影像*，可透過![](2d-view.resources/2d-view-08.png)**物理大小比率**&#x200B;按鈕啟用
* 保持觀看大小：此選項 *鎖定顯示縮放* ，讓它在不同圖片中保持一致。 預設是&#x200B;*啟用*&#x200B;的，可以透過「保留觀看大小&#x200B;**」按鈕來關閉![](2d-view.resources/2d-view-09.png)**
...
+++背景影像
![2D 查看背景圖片](2d-view.resources/2d-view-10.png "2D 查看背景圖片"){width="360px"}



你可以 *在目前顯示的圖片上疊加不同的圖片* 。 按下![](2d-view.resources/2d-view-11.png)<b>背景圖片</b>按鈕，系統會提示您選擇一個圖片檔案作為覆蓋層。

選擇檔案後，會出現一個新工具列，並包含以下影像覆蓋控制：

<b>![](2d-view.resources/2d-view-12.png) 結束：</b> *關閉* 覆蓋控制工具列並 *停用* 背景影像覆蓋。

<b>![](2d-view.resources/2d-view-13.png) 載入圖片：</b> 選擇 *另一個圖片檔案* 作為覆蓋層使用。

<b>![](2d-view.resources/2d-view-14.png) 來源影像：</b> 將覆蓋影像設定為 *0%* 不透明度。

<b>![](2d-view.resources/2d-view-15.png) 背景圖片：</b> 將覆蓋圖設定為 *100%* 不透明度。

<b>![](2d-view.resources/2d-view-16.png) 重置：</b> 將覆蓋影像設定為 *50%* 透明度。
...
+++匯出影像
![2D 檢視匯出圖片](2d-view.resources/2d-view-17.png "2D 檢視匯出圖片"){width="360px"}



目前顯示的圖片可以 *匯出成圖片檔案*。 按下![](2d-view.resources/2d-view-18.png)<b>儲存影像......</b>按鈕，系統會提示您選擇&#x200B;*匯出檔案的位置*、*名稱*&#x200B;和&#x200B;*檔案格式*。
...
+++複製到夾板
![2D 檢視複製到剪貼簿](2d-view.resources/2d-view-19.gif "2D 檢視複製到剪貼簿"){width="360px"}



目前顯示的圖片可以 *複製到剪貼板*。 按下![](2d-view.resources/2d-view-20.png)<b>「複製圖片到剪貼簿</b>」按鈕，圖片即可貼上到任何第三方軟體，例如 Adobe Photoshop。
...
+++切換圖輸出
![2D 視圖切換圖輸出](2d-view.resources/2d-view-21.gif "2D 視圖切換圖輸出"){width="360px"}



如果目前顯示的影像是圖形輸出&#x200B;*，你可以*&#x200B;透過<b>![](2d-view.resources/2d-view-22.png)選擇輸出</b>按鈕快速切換到任何其他&#x200B;*圖形*&#x200B;輸出。
...
+++紫外線覆蓋
![2D 視圖 UV 覆蓋](2d-view.resources/2d-view-23.png "2D 視圖 UV 覆蓋"){width="357px"}



如果<b>在 3D View[&#128279;](../../interface/3d-view/3d-view.md) 底座的場景</b>選單中啟用<b>了「在 2D View</b> 中顯示 UV」選項，那麼 2D View 中即可使用UV 覆蓋功能。

你可以用 <b>UV</b> 按鈕啟用。 ![](2d-view.resources/2d-view-24.png)
...
+++圖片資訊
![2D 查看影像資訊](2d-view.resources/2d-view-25.png "2D 查看影像資訊"){width="360px"}



你可以透過資訊面板顯示&#x200B;*影像中的精確像素值**和座標*，該面板是透過![](2d-view.resources/2d-view-26.png)<b>影像資訊</b>按鈕啟用的。</b> <b>這在檢查 HDR 影像時非常有用，或確保像素間的移動符合預期的進展。
...
+++直方圖
![2D 檢視直方圖](2d-view.resources/2d-view-27.png "2D 檢視直方圖"){width="360px"}



你可以用<b>直方圖</b>面板顯示&#x200B;*影像的直方圖*，該面板是透過![](2d-view.resources/2d-view-28.png)<b>顯示直方圖</b>按鈕啟用的。
...
![2D 查看色彩通道](2d-view.resources/2d-view-29.png "2D View 色彩通道"){width="360px"}

### 彩色通道

你可以用![](2d-view.resources/2d-view-30.png)<b>「色彩通道」</b>按鈕顯示圖片的單一通道。這會開啟一個組合框，讓你選擇顯示紅<b></b>、<b>綠</b><b>、藍</b><b>和阿爾法</b>四個頻道。透過選擇 <b>RGB</b> 選項，所有通道影像的正常畫面會被恢復。
...
![2D 顯示透明度](2d-view.resources/2d-view-31.png "切換 2D 顯示透明度切換"){width="360px"}

### 透明度切換

透明度顯示可以透過 / <b>![](2d-view.resources/2d-view-33.png) 顯示棋盤格</b>按鈕開關![](2d-view.resources/2d-view-32.png)。啟用此功能後，透明度會以棋盤格圖案顯示。

有兩種主要的透明度解讀方式，可以透過 /![](2d-view.resources/2d-view-35.png) <b>透明度模式</b>按鈕選擇![](2d-view.resources/2d-view-34.png)：

<b>![](2d-view.resources/2d-view-34.png) 直線：</b> 透明度資訊僅儲存在 alpha 通道中，不影響影像的其他部分

<b>![](2d-view.resources/2d-view-35.png) 預乘法：</b> 透明度資訊儲存在 alpha 通道中，且同時影響 RGB 通道，因為它們實際上是與 alpha 通道相乘

為了顯示&#x200B;**&#x200B;正確的顏色，應在 <b>2D 檢視</b>面板中選擇適當的透明度模式，以符合影像創建&#x200B;**&#x200B;時所套用的透明度方法。

![2D 查看色彩空間](2d-view.resources/2d-view-36.png "2D 查看色彩空間"){width="360px"}

### 色彩空間

為了最準確的色彩呈現，影像預設會以&#x200B;*與螢幕*&#x200B;使用的&#x200B;*色彩空間相符的色彩空間*&#x200B;顯示。

可用的控制項和 / <b>![](2d-view.resources/2d-view-38.png) 色彩空間</b>按鈕的效果![](2d-view.resources/2d-view-37.png)會依專案設定[&#128279;](../../interface/preferences-window/project-settings/project-settings.md)中的[色彩管理模式](../../color-management/color-management.md)而定。想了解更多這些控制，請參考本頁的色彩管理區。
...
![2D 視圖繪製工具](2d-view.resources/2d-view-39.png "2D 視圖繪製工具")
...
![2D 顯示向量圖形編輯器](2d-view.resources/2d-view-40.png "2D 檢視向量圖形編輯器")
...
![2D 檢視色彩管理](2d-view.resources/2d-view-41.png "2D 檢視色彩管理"){width="360px"}
...
* <b>遺留：</b> 你可以將影像置入 ![](2d-view.resources/2d-view-37.png) sRGB 或 ![](2d-view.resources/2d-view-38.png) 線性 sRGB 色彩空間;
* <b>Adobe ACE：</b>你可以![](2d-view.resources/2d-view-37.png)*啟用*&#x200B;色彩管理，並根據 Adobe ACE 引擎偵測到的，設定目前&#x200B;*螢幕*&#x200B;最合適的色彩空間，或![](2d-view.resources/2d-view-38.png)*關閉*&#x200B;色彩管理並以 Raw 色彩值顯示影像;
* <b>OCIO：</b>你可以![](2d-view.resources/2d-view-37.png)*啟用*&#x200B;色彩管理，並依 OCIO 引擎偵測到的設定最適合目前螢幕&#x200B;*的色彩管理，*&#x200B;使用組合框選擇 OCIO 設定檔[&#128279;](../../color-management/color-management.md)中可用的任何&#x200B;*顯示色彩空間*，或![](2d-view.resources/2d-view-38.png)*關閉*&#x200B;色彩管理並使用 Raw 色彩值顯示影像。
