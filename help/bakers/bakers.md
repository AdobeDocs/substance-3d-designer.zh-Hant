...
![3D 場景資源情境選單中的「烘焙模式資訊」選項 3D 場景資源情境選](bakers.resources/bakers-01.png "單中的「烘焙模式資訊」選項")
...
![Bakers 渲染列表](bakers.resources/bakers-07.png "Bakers 渲染列表")
