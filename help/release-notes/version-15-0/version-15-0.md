...
![橫幅](version-15-0.resources/banner-47.png "版本 15.0 橫幅")
...
![Designer 15.0 的後期效果](version-15-0.resources/postfx.gif)
...
![USD 場景已載入並用 Designer 渲染](version-15-0.resources/feature_2.png)
...
![混合節點](version-15-0.resources/blend.gif)

</td>
<td style="border: 0;" valign="top">

![模糊節點](version-15-0.resources/blur.gif)

</td>
<td style="border: 0;" valign="top">

![距離節點](version-15-0.resources/distance.gif)
...
![不同的U型比例](version-15-0.resources/nonsquare.png){zoomable="yes"}
...
[![Substance 3D 設計師更新：新增渲染器、後製特效與上下文編輯 |Adobe Substance 3D](version-15-0.resources/video_15.png)](https://www.youtube.com/watch?v=6EkXxu-0Q_E)
