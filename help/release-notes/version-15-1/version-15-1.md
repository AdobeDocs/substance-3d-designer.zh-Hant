...
![旗幟設計師 15.1](version-15-1.resources/bannerweb.png)
...
![重新設計 新圖形視窗](version-15-1.resources/newgraph.png){zoomable="yes"}
...
![新的範例圖建立視窗](version-15-1.resources/GraphSample.png){zoomable="yes"}
...
![材料設計中的木材樣本](version-15-1.resources/samplegraph.png){zoomable="yes"}
...
![方向性無序雜訊](version-15-1.resources/directionaldisorder.gif){zoomable="yes"}
...
![類別 1 的節點搜尋](version-15-1.resources/search1-2.png){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![類別 2 的節點搜尋](version-15-1.resources/search2.png){zoomable="yes"}
...
<table>
  <tr>
    ...
    <td>
      <img src="version-15-1.resources/defaultouput1.png" alt="預設輸出中，縮圖永遠是相關的。">
      <br><i>之後</i>
    </td>
  </tr>
</table>
...
![是定義節點](version-15-1.resources/isdefined.png){zoomable="yes"}
